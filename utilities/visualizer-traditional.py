...
class SheetMusicVisualizer:
    def __init__(self, sheet_music: SheetMusic):
        ...
        # Map diatonic notes to vertical staff positions (C4 = 0)
    ...
    def visualize(self):
        ...
        # We will visualize just the first track for this simple example
...
if __name__ == "__main__":
    ...
    m2.add_event(NoteEvent(note=Note("A#", 4), duration=Duration.QUARTER)) # Testing an accidental
